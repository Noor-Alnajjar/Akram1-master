...
public class MainFragment extends Fragment implements OnMapReadyCallback, LocationListener,
    ...
    private void counter() {
        ...
        if (countnumber == 0) {
            nextmode = " To " + mFusedLocationClient.getApplicationContext().getResources().getString(R.string.to_advance);
        } else if (countnumber == 1) {
            nextmode = " To " + mFusedLocationClient.getApplicationContext().getResources().getString(R.string.to_extreme);
        } else {
